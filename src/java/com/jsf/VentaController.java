...
public class VentaController implements Serializable {
    ...
    @EJB
    private com.bean.VentaFacade ejbFacade;
    ...
    public Venta getSelected() {
        if (current == null) {
            current = new Venta();
            current.setVentaPK(new com.VentaPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String create() {
        try {
            current.getVentaPK().setClienteIdCliente(current.getCliente().getIdCliente());
    ...
    public static class VentaControllerConverter implements Converter {
        ...
        com.VentaPK getKey(String value) {
            com.VentaPK key;
        ...
        String getStringKey(com.VentaPK value) {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Venta) {
                ...
                return getStringKey(o.getVentaPK());
            } else {
